...
const { getPost, post, validationErrors,updatePost } = usePosts();
    ...
    <form @submit.prevent="updatePost(post)">
        <div>
            ...
            <input v-model="post.title" type="text"
                class="black block mt-1 w-full text-black rounded-md shadow-sm boarder-gray-600" />
        ...
        <div class="mt-4">
            ...
            <textarea v-model="post.content" type="text"
                class="black block mt-1 w-full text-black rounded-md shadow-sm boarder-gray-600" />
            <div class="texr-red-600 mt-1">
